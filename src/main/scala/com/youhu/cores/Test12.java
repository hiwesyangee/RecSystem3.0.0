...
public class Test12 {
    public static void main(String[] args) {
        ...
        JavaRDD<String> firstLine0 = sc.textFile("/Users/hiwes/data/zui.txt");
        JavaRDD<String> common = firstLine0.filter(new Function<String, Boolean>() {
            ...
            public Boolean call(String str) throws Exception {
                ...
                return biaoshi.equals("COMMON") && (inArr[0].equals("login") || inArr[0].equals("offline"));
            }
        });
        ...
        File f = new File("/Users/hiwes/data/zui.log");
        FileWriter fw = null;
